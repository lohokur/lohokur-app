...
// render (useMe refreshes on the lk-gen-used event); links to /pricing to upgrade.
export default function GenMeter() {
  ...
  return (
    <Link
      ...
      title={out ? 'Out of generations — upgrade for more' : `${remaining === Infinity ? '' : remaining + ' '}AI generations left this month`}
    >
